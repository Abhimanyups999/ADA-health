...
public class View_visited_game extends AppCompatActivity {
    GridView gv;
    String[] gamecode,name;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_visited_game);


       gv=(GridView) findViewById(R.id.grid);
       //gv.setOnItemClickListener(this);

        Intent in=new Intent(getApplicationContext(),macservice.class);
        stopService(in);
